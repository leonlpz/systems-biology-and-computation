...
t_sample=10; %sample interval for gathering data
...
t_array(1,t_end/t_sample)=0; t_array(1,j)=t; %time array and initial value
Pro_array(1,t_end/t_sample)=0; Pro_array(1,j)=Pro; %promoter array and initial value
M_array(1,t_end/t_sample)=0; M_array(1,j)=M; %mRNA array and initial value
P_array(1,t_end/t_sample)=0; P_array(1,j)=P; %protein array and initial value
...
%steady-state noise protein:
noise_protein_theoretical = sqrt((1/mean_protein_theoretical)+ (1/(mean_mRNA_theoretical*(1+(dM/dP)))))
